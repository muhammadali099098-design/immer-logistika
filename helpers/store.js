...
const TABLES = {
  ...
  load_trucks: ["id", "logistics_id", "factory_id", "truck_no", "invoice_no", "date", "lines", "notes", "created_at"],
  shipments: ["id", "logistics_id", "date", "arrival_date", "pi_number", "doc_number", "extra_fee", "truck_no", "volume_m3", "cost_amount", "cost_currency", "lines", "notes", "created_at", "payment_status", "payment_file", "receipt_status", "receipt_file", "damaged", "damage_amount", "demurrage_days", "demurrage_rate"],
  tashkent_out: ["id", "logistics_id", "date", "truck_no", "lines", "notes", "created_at"],
  payments: ["id", "logistics_id", "amount", "currency", "file_name", "date", "created_at"],
};
