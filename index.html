...
const TABLES = {
  ...
  shipments: ["id", "logistics_id", "date", "truck_no", "volume_m3", "cost_amount", "cost_currency", "lines", "notes", "created_at", "payment_status", "payment_file", "receipt_status", "receipt_file", "damaged", "damage_amount", "demurrage_days", "demurrage_rate"],
