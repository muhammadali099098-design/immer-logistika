...
// Never let the browser cache the app files — otherwise after every deploy it
// keeps showing the old version (the recurring "nothing changed" symptom).
...
// Return the logistics scope for a user: admin = all (null), logistic = own company.
// A logistic with no company sees NOTHING (never all).
