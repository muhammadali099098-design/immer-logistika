...
function viewSummary() {
  ...
  return `
    ...
    <div class="tbl-wrap"><table class="table">
      <thead><tr><th>Модель</th><th>Категория</th>${showLog ? "<th>Логист</th>" : ""}<th>Остаток</th><th>Общий куб</th><th>Пришло</th><th>Отгружено</th><th>Завод</th><th>Инвойс</th><th>Дата забора</th><th>Дата отправки в Ташкент</th><th>Дней на складе</th><th>Статус</th></tr></thead>
      <tbody>
