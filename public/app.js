...
function viewSummary() {
  ...
  return `
    ...
    <div class="tbl-wrap"><table class="table">
      <thead><tr><th>Модель</th><th>Категория</th>${showLog ? "<th>Логист</th>" : ""}<th>Остаток</th><th>Объём, м³</th><th>Пришло</th><th>Отгружено</th><th>Завод</th></tr></thead>
      <tbody>
        ${rows.length === 0 ? `<tr><td colspan="${showLog ? 8 : 7}"><div class="emptystate">Нет данных под фильтр. Добавьте загрузку.</div></td></tr>` : rows.map((r) => `<tr>
