...
function viewSummary() {
  ...
  return `
    ...
    <div class="tbl-wrap"><table class="table">
      <thead><tr><th>Модель</th><th>Категория</th>${showLog ? "<th>Логист</th>" : ""}<th>CBM/шт</th><th>Остаток</th><th>Объём</th><th>Пришло</th><th>Отгружено</th><th>Завод</th><th>Инвойс</th><th>Дата забора</th><th>Дней на складе</th></tr></thead>
      <tbody>
        ${rows.length === 0 ? `<tr><td colspan="${showLog ? 12 : 11}"><div class="emptystate">Нет данных под фильтр. Добавьте загрузку.</div></td></tr>` : rows.map((r) => `<tr>
